...
define('TEXT_PRODUCT_QUANTITY', ' Antal p&aring; lager');
...
define('IMAGE_BUTTON_PREVIOUS','Forrige vare');
define('IMAGE_BUTTON_NEXT','N&aelig;ste vare');
define('IMAGE_BUTTON_RETURN_TO_PRODUCT_LIST','Tilbage til produkt listen');
...
define('TEXT_ATTRIBUTES_PRICE_WAS',' [var: ');
define('TEXT_ATTRIBUTE_IS_FREE',' er nu: Gratis]');
define('TEXT_ONETIME_CHARGE_SYMBOL', ' *');
define('TEXT_ONETIME_CHARGE_DESCRIPTION', ' One time charges may apply');
define('TEXT_ATTRIBUTES_QTY_PRICE_HELP_LINK','M&aelig;ngderabat er muligt');
