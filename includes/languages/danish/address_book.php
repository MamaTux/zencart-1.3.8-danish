...
define('NAVBAR_TITLE_2', 'Adresse bog');

define('HEADING_TITLE', 'Min personlige adressebog');

define('PRIMARY_ADDRESS_TITLE', 'Primær adresse');
...
define('PRIMARY_ADDRESS', '(primær adresse)');
